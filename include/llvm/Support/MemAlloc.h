...
LLVM_ATTRIBUTE_RETURNS_NONNULL LLVM_ATTRIBUTE_RETURNS_NOALIAS void LLVMCLANG_EXPORT *
...
void LLVMCLANG_EXPORT deallocate_buffer(void *Ptr, size_t Size, size_t Alignment);
